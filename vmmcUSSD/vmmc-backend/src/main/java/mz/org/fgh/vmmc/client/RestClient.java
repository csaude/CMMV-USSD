...
public class RestClient {
	...
	public List<Province> getAllProvinces() {
		...
		List<Province> lista = Arrays.asList((Province[]) objects).stream()
				.sorted(Comparator.comparing(Province::getCode)).collect(Collectors.toList());
		return lista;
	}
	...
	public UtenteRegisterResponse registerUtente(@RequestBody UtenteRegisterRequest request) {
		...
		Response response = target.request().header("X-Auth-Token", token)
